...
const MensCloth = () => {
    ...
    const mensData = productData.filter(data => data.category.startsWith('m'))
    ...
    return (
        ...
        <div className="navbar-light bg-light pt-8">
            <div className="w-full flex justify-center">
                <h1 className="text-3xl font-bold my-10"> Mens Available Products : {mensData.length}</h1>
            </div>
            <div className="p-2 grid grid-cols-4">
                {
                    mensData.map((currData, index) => (
